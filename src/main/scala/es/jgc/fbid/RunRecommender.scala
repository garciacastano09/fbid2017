...
//    spark.sparkContext.setCheckpointDir("/Users/jgc/dev/muirst/fbid/fbid2017/spark-warehouse")
    spark.sparkContext.setCheckpointDir("hdfs://"+hdfsAddress+"/tmp/")
    println("Checkpoint set "+hdfsAddress)

    //    val base = "hdfs://127.0.0.1:9000/user/ds/"
    val base = "/Users/jgc/dev/muirst/fbid/fbid2017/data/"
    println("Base data dir "+hdfsAddress)
